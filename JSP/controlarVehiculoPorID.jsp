...
<div id="tabs">
	<ul>
		<li><a href="#tabs-0">Controlar Vehiculo por ID</a>
	...
	<div id="tabs-0">
		<div id="vehiculo">
			<h1>Veh&iacute;culo #<%= vehiculo.getIdVehiculo() %></h1>
			<br />
			<div id="datosVehiculo">
				<u>Tipo</u>: <%= vehiculo.getTipo() %><br />
				<u>Estado</u>: <%= vehiculo.getEstado() %><br />
				<u>Kilometraje</u>: <%= vehiculo.getKilometraje() %><br />
				<u>Fecha &Uacute;ltimo Control</u>: <%= vehiculo.getFechaUltimoControl() %><br />
			</div>
			<br />
		</div>
	</div>
