			...
			<main class="col-md-9">
				<section class="col-md-12">
					...
					<form action="AltaPedido" method="POST">
						<div class="row">
							<div class="col-md-4">
								<label for="solicitaEnvioConUrgencia">Solicita envío con urgencia</label>
								<select id="EnvioConUrgencia" name="EnvioConUrgencia" class="form-control" required>
									<option selected="selected">Seleccione una opción...</option>
									<option>No solicita</option>
									<option>Vehiculo directo</option>
									<option>Avioneta Particular </option>
								</select>
							</div>
							<div class="col-md-4">
								<label for="SolicitaContratacionDeProveedor">Solicita contratación de Proveedor</label>
								<select id="ContratacionDeProveedor" name="ContratacionDeProveedor" class="form-control" required>
									<option selected="selected">Seleccione una opción...</option>
									<option>No Solicita</option>
									<option>Vehiculo a granel</option>
